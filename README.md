...
```python
from application.ogame.constants import coordinates, destination
...
```python
from application.ogame.constants import coordinates, ships, mission, speed
...
```python
from application.ogame.constants import buildings
...
```python
from application.ogame.constants import ships
...
```python
from application.ogame.constants import research
